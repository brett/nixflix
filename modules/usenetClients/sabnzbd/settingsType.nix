  ...
  miscType = types.submodule {
    ...
    options = {
      ...
      propagation_delay = mkOption {
        type = types.int;
        # default = 5; # TRaSH-recommended: avoids downloading incomplete posts
        default = 0;
        description = ''
